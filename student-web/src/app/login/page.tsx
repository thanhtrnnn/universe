    ...
    <div className="bg-background min-h-screen flex items-center justify-center p-lg font-inter text-on-surface antialiased">
      <main className="w-full max-w-[440px] bg-surface-container-lowest rounded-2xl shadow-[var(--shadow-float)] border border-outline-variant/30 p-xl flex flex-col gap-xl">
        ...
        <header className="flex flex-col items-center text-center gap-3">
          <div className="w-16 h-16 bg-primary-container rounded-2xl flex items-center justify-center mb-1 shadow-md">
            <span
          ...
          <div className="flex flex-col gap-1">
            <p className="text-body-md font-semibold text-on-surface">Cổng thông tin Sinh viên</p>
            <p className="text-body-sm text-on-surface-variant">Đăng nhập để xem lịch học, học phí và kết quả học tập</p>
          </div>
        </header>
        ...
        <footer className="text-center">
          <p className="text-body-sm text-outline">
            Hệ thống dành riêng cho Sinh viên • UniVerse &copy; 2026
          </p>
        </footer>
      </main>
    </div>
