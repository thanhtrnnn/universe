...
const mockConversations: Conversation[] = [
  { id: "c1", name: "Lớp IT101-01", type: "group", lastMessage: "Chào cả lớp, tuần này học online nhé.", unreadCount: 0 },
  { id: "c2", name: "Lớp IT202-02", type: "group", lastMessage: "Có ai làm xong bài tập chưa?", unreadCount: 5 },
  { id: "p1", name: "Nguyễn Văn B (Sinh viên)", type: "private", lastMessage: "Thầy cho em hỏi phần này...", unreadCount: 1, isOnline: true },
  { id: "p2", name: "Admin Đào Tạo", type: "private", lastMessage: "Lịch học bù sẽ xếp vào thứ 7 nhé.", unreadCount: 0, isOnline: true },
];

const mockMessages: Record<string, Message[]> = {
  "c1": [
    { id: "m1", senderId: "t1", senderName: "Trần Văn A", content: "Chào cả lớp, tuần này học online nhé.", timestamp: "08:00 AM", isMine: true },
    { id: "m2", senderId: "s1", senderName: "Sinh viên 1", content: "Dạ vâng ạ.", timestamp: "08:05 AM", isMine: false },
    { id: "m3", senderId: "s2", senderName: "Sinh viên 2", content: "Dùng link Google Meet cũ đúng không thầy?", timestamp: "08:10 AM", isMine: false },
  ],
  "p1": [
    { id: "m4", senderId: "s1", senderName: "Nguyễn Văn B", content: "Thầy cho em hỏi phần này...", timestamp: "Hôm qua", isMine: false },
  ]
};
      ...
      <div className="flex justify-between items-end mb-lg shrink-0">
        <div>
          ...
          <p className="text-body-md text-on-surface-variant mt-1">
            Giao tiếp với sinh viên và phòng đào tạo
          </p>
        </div>
      </div>
