...
export default function SettingsPage() {
  ...
  return (
    <main className="flex-1 overflow-y-auto mt-16 p-xl bg-background">
      ...
      <p className="text-body-md text-on-surface-variant mb-lg">Tùy chỉnh giao diện hệ thống.</p>
      ...
      <div className="max-w-6xl">
        ...
        <div className="bg-surface-container-lowest rounded-xl p-xl shadow-[var(--shadow-card)] border border-border-muted">
          ...
          <div className="flex items-center justify-between py-md border-b border-border-muted">
            ...
            <button className="px-4 py-2 border border-outline-variant rounded-lg text-button text-on-surface hover:bg-surface-container transition-colors">
              Thay đổi
            </button>
          </div>
          <div className="flex items-center justify-between py-md">
            ...
            <button className="px-4 py-2 border border-error/30 rounded-lg text-button text-error hover:bg-error/10 transition-colors">
              Đăng xuất
            </button>
          </div>
        </div>
